---
title: Point Cloud Segmentation for Agricultural Robotics
authors:
  - name: Zach Charlick
...
links:
  ...
  - name: Code
    url: https://drive.google.com/drive/folders/1PNXGeC8mVRfseKUukU7hXr_JMkYN3Be-?usp=sharing
    icon: ri:github-line
  - name: Poster
...
import HeroImage from "./assets/Stembot.jpg"

<Picture src={HeroImage} alt="Photo of STEMbot on tomato stem" />

<HighlightedSection>

## Abstract

Agricultural robots like STEMbot (Figure 1) seek to enable autonomous navigation of dense plant canopies. For motion planning, STEMbot must reason about plant semantics like stem, and leaves.  We augment traditional point cloud segmentation algorithms where plant observations are static and complete, with a new dataset of partial point cloud observations along a simulated STEMbot trajectory. Using transformers and an LSTM, our models reason about sequential, overlapping observations to improve temporal consistency between sequential point classifications compared to the PTv3 baseline.
